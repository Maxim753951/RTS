...
// ћы создаем новый Building экземпл€р, использу€ BuildingData ссылку, чтобы у него были все необходимые метаданные.
// ” экземпл€ра также есть игровой объект и преобразование, св€занное с ним, потому что это реальный объект в сцене.
...
public class Building
{
    ...
    // Another useful thing is to "transfer" the BuildingDataСs CanBuy() function into our Building class so we can call the first one more quickly
    public bool CanBuy()
    {
        return _data.CanBuy();
    }
